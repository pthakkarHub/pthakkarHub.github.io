(function($){$.fn.tipuesearch=function(options){var set=$.extend({'show':7,'newWindow':false,'showURL':false,'showTitleCount':true,'minimumLength':3,'descriptiveWords':25,'highlightTerms':true,'highlightEveryTerm':false,'mode':'static','liveDescription':'*','liveContent':'*','contentLocation':'tipuesearch/tipuesearch_content.json','debug':false},options);return this.each(function(){var tipuesearch_in={pages:[]};$.ajaxSetup({async:false});var tipuesearch_t_c=0;if(set.mode=='live')
...
var t2_1=html.toLowerCase().indexOf('<meta property="og:title" content="');var t2_2=html.toLowerCase().indexOf('">',t2_1+35);if(t2_1!=-1&&t2_2!=-1)
{var dp_tit=html.slice(t2_1+35,t2_2);}
var t3_1=html.toLowerCase().indexOf('<meta name="description" content="');var t3_2=html.toLowerCase().indexOf('">',t3_1+34);if(t3_1!=-1&&t3_2!=-1)
{var dp_desc=html.slice(t3_1+34,t3_2);}
tipuesearch_in.pages.push({"dp_title":dp_tit,"dp_desc":dp_desc,"title":tit,"text":desc,"tags":cont,"url":tipuesearch_pages[i]});});}}
if(set.mode=='json')
...
{score=0;}}}
if(score!=0)
{found.push({"score":score,"title":tipuesearch_in.pages[i].dp_title,"desc":tipuesearch_in.pages[i].dp_desc,"url":tipuesearch_in.pages[i].url});c++;}}}
else
...
{out+='<div class="panel panel-default"><div class="panel-header"><h3><a href="'+found[i].url+'"'+tipue_search_w+'>'+found[i].title+'</a></div>';if(set.debug)
